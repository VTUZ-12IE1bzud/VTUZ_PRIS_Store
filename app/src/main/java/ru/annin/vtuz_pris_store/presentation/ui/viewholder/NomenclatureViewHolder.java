...
import ru.annin.vtuz_pris_store.presentation.ui.adapter.NomenclatureListAdapter;
 ...
 */
public class NomenclatureViewHolder extends BaseViewHolder {
    ...
    // Adapter's
    private final NomenclatureListAdapter adapter;

    private OnInteractionListener listener;

    public NomenclatureViewHolder(@NonNull View view) {
        super(view);
        ...
        // Setup
        adapter = new NomenclatureListAdapter();
    ...
    public NomenclatureViewHolder showNomenclature(RealmResults<NomenclatureModel> data) {
